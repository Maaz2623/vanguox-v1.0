      ...
      <ReactMarkdown
        ...
        components={{
          ...
          code: ({ className, children }) => {
            ...
            return (
              <code className="bg-neutral-300 dark:bg-neutral-700 px-1 py-0.5 rounded text-[14px] font-mono">
                {children}
              </code>
            );
          },
          ...
          table: (props) => (
            <table
              className="table-auto w-full border-collapse border border-neutral-400 dark:border-neutral-600 mb-4"
              {...props}
            />
          ),
          thead: (props) => (
            <thead className="bg-neutral-200 dark:bg-neutral-700" {...props} />
          ),
